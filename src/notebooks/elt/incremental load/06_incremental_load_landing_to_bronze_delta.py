...
def process_table(spark, table_name, table_name_converted, input_table_path, output_table_path):
    ...
    try:
        ...
        if  rows_to_update == 0:
            ...
            df_with_update_date = func_file.add_data_last_update(df_update_data_to_bronze)
...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers=8) as executor:
        ...
        for table_name in config_file.tables_postgres_adventureworks.values():
            ...
            futures.append(executor.submit(process_table, spark, table_name, table_name_converted, landing_table_path, bronze_table_path))
